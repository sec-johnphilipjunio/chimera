...
4. **Clone & Run:**
```powershell
git clone [https://github.com/your-username/chimera.git](https://github.com/your-username/chimera.git)
cd chimera
cargo run
...
3. **Clone & Run:**
```bash
git clone [https://github.com/your-username/chimera.git](https://github.com/sec-johnphilipjunio/chimera.git)
cd chimera
cargo run
